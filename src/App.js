...
import spark from '../src/assets/sparkler-sample.png'
      ...
      <div className="container">
        ...
        <div className="mainBox">
          ...
          <div className='content'>
            ...
            <button type='button' class='btn' onClick={()=>setIscompletedScreen (false)}>
          ...
          <div className='div1'>
            <div className='div2'>
              <div className='div3'>
                ...
                <IoIosArrowDropupCircle  className='upArrow' onClick={()=>setIscompletedScreen(true)}/>
              </div>
              <div className='costA'>
                 Cost Identification
              </div>
            ...
            <div className='div4'>
              <div className='quest'>
                ...
                <button type='button' onClick={()=>setIsScreen(false)} className='plus'><FiPlus className='plus' />
                </button>
              ...
              <div className='quest'>
                <div className='question'>Question 1 out of 3</div>
                <button type='button' onClick={()=>setIsScreen(true)} className='plus'><FiMinus className='plus' />
                </button>
